package com.qwlyz.androidstudy.pp;
...
public class GlidePalette<TranscodeType> extends BitmapPalette implements RequestListener<TranscodeType> {
    ...
    @Override public boolean onLoadFailed(GlideException e, Object model, Target<TranscodeType> target, boolean isFirstResource) {
